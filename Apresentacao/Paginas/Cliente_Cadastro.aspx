<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCliente.Master" AutoEventWireup="true" CodeBehind="Cliente_Cadastro.aspx.cs" Inherits="Apresentacao.Paginas.Cliente_Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td align="center" class="auto-style1" colspan="2" style="font-family: 'Britannic Bold'; font-size: xx-large">Cadastro de Cliente</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlTipoCliente" runat="server" Height="20px" Width="150px">
                <asp:ListItem>Selecione...</asp:ListItem>
                <asp:ListItem Value="2">Cliente</asp:ListItem>
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="ddlTipoCliente" ErrorMessage="* CAMPO OBRIGATÓRIO!" ForeColor="Red" ValidationGroup="SalvarUsuario"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td align="right" class="auto-style3">
